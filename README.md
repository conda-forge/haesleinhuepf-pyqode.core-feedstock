About haesleinhuepf-pyqode.core
===============================
...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/haesleinhuepf-pyqode.core-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15357&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/haesleinhuepf-pyqode.core-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `haesleinhuepf-pyqode.core` can be installed with:

```
conda install haesleinhuepf-pyqode.core
```

It is possible to list all of the versions of `haesleinhuepf-pyqode.core` available on your platform with:
